    ...
    switch (locale) {
      case 'he':
        return {
          ...
          'faq_12_a':
              'בכלי העסק לחצו יצירת מסמך. לאחר אימות הזהות בחרו סוג מסמך: הצעת מחיר, הזמנת עבודה, חשבון עסקה, חשבונית, חשבונית/קבלה, זיכוי או קבלה, לפי סיווג העסק. בחרו או הוסיפו לקוח, הוסיפו פריטים, מחירים, מע״מ או תשלומים, עברו לתצוגה מקדימה ושמרו.',
          ...
          'faq_15_a':
              'במסמכים שמורים אפשר לעבור בין מסמכים שיצרתם למסמכים שנשלחו אליכם, לסנן לפי סוג, תאריך וסטטוס ולפתוח PDF. אפשר לשלוח מסמך לאיש קשר, לשלוח הצעת מחיר או הזמנת עבודה לחתימה, ליצור קבלה מלאה או חלקית מחשבונית, ליצור זיכוי, ליצור קבלה מבטלת ולעקוב אחר מצב תשלום והקצאה.',
      ...
      case 'ar':
        return {
          ...
          'faq_12_a':
              'من أدوات النشاط اضغط إنشاء مستند. بعد التحقق من الهوية اختر عرض سعر أو أمر عمل أو فاتورة أولية أو فاتورة أو فاتورة/إيصال أو إشعار دائن أو إيصال حسب تصنيف النشاط. اختر عميلًا، وأضف البنود والأسعار والضريبة أو الدفعات، ثم عاين المستند واحفظه.',
          ...
          'faq_15_a':
              'يمكن التبديل بين المستندات التي أنشأتها والتي أُرسلت إليك، والتصفية حسب النوع والتاريخ والحالة وفتح PDF. يمكنك إرسال مستند، وإرسال عرض سعر أو أمر عمل للتوقيع، وإنشاء إيصال كامل أو جزئي من فاتورة، وإنشاء إشعار دائن أو إيصال إلغاء، ومتابعة حالة الدفع والتخصيص.',
      ...
      default:
        return {
          ...
          'faq_15_a':
              'Switch between documents you created and documents sent to you, filter by type, date, and status, and open the PDF. You can send a document, send a Quote or Work Order for signature, create a full or partial Receipt from an Invoice, create a Credit Note or cancellation Receipt, and track payment and allocation status.',
