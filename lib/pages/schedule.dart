    ...
    switch (locale) {
      ...
      case 'ar':
        return {
          ...
          'partial_title': 'اختر ساعات العمل',
          'from': 'من',
          'to': 'إلى',
          'save': 'حفظ',
          'cancel': 'إلغاء',
          'ok': 'موافق',
          'confirm_msg':
              'إلغاء يوم العمل سيحذف جميع التذكيرات لهذا اليوم. هل تريد المتابعة؟',
          'not_working': 'لا يوجد نشاط في هذا اليوم',
          'working_hours': 'ساعات العمل',
          'hidden_msg': 'جدول المهني مخفي',
          'request_work': _onlineOnly
              ? 'احجز جلسة أونلاين في هذا اليوم'
              : _customerTravels
              ? 'احجز موعدًا في هذا اليوم'
              : 'اطلب من المهني العمل في هذا اليوم',
          'request_hours': _onlineOnly
              ? 'احجز جلسة أونلاين خلال هذه الساعات'
              : _customerTravels
          ...
          'vacation_confirm': 'هل أنت متأكد أنك تريد إلغاء هذه الإجازة؟',
          'permanent_off': 'يوم عطلة ثابت',
          'weekend_msg': 'لا يمكن إرسال طلبات في يوم العطلة الثابت للمهني.',
          'vacation_conflict': 'لا يمكن تحديد يوم عمل أثناء الإجازة.',
          'work_conflict':
              'لا يمكن تحديد إجازة في يوم عمل موجود. ألغِ يوم العمل أولاً.',
          'working_day': 'يوم عمل',
          'has_reminders': 'تذكيرات',
          'notes': 'ملاحظات اليوم',
          'notes_hint': 'اكتب ملاحظاتك الشخصية هنا...',
          'invalid_hours': 'يجب أن يكون وقت الانتهاء بعد وقت البداية.',
          'overlap_hours': 'لا يمكن أن تتداخل الفترات الزمنية مع بعضها.',
          'add_time_range': 'إضافة فترة زمنية',
          'remove_time_range': 'حذف الفترة',
          'time_range': 'الفترة الزمنية',
          'multi_hours_hint': 'يمكنك إضافة أكثر من فترة ساعات عمل لليوم نفسه.',
          'selected_hours': 'الساعات المحددة',
          'edit_hours_hint': 'اضغط "ساعات عمل جزئية" لتعديل الفترات.',
          'clock_hint': 'اضغط على وقت البداية أو النهاية لفتح الساعة.',
          'range_count': 'عدد الفترات',
          'hours_preview': 'معاينة الساعات',
          'save_hours_failed': 'فشل حفظ ساعات العمل. حاول مرة أخرى.',
        };
      case 'am':
        return {
          'title': 'መርሃ ግብር',
          'manage_title': 'መርሃ ግብር አስተዳደር',
          ...
          'partial_title': 'የስራ ሰዓታትን ይምረጡ',
          'from': 'ከ',
          'to': 'እስከ',
          'save': 'አስቀምጥ',
          'cancel': 'ሰርዝ',
          'ok': 'እሺ',
          'confirm_msg': 'የስራ ቀኑን መሰረዝ ማስታወሻዎችን ያጠፋል። ቀጥል?',
          'not_working': 'በዚህ ቀን ስራ የለም',
          'working_hours': 'የስራ ሰዓታት',
          'hidden_msg': 'የባለሙያው መርሃ ግብር ተደብቋል',
          'request_work': _onlineOnly
              ? 'በዚህ ቀን ኦንላይን ስብሰባ ያስይዙ'
              : _customerTravels
              ? 'በዚህ ቀን ቀጠሮ ያስይዙ'
              : 'ባለሙያው በዚህ ቀን እንዲሰራ ይጠይቁ',
          'request_hours': _onlineOnly
              ? 'በእነዚህ ሰዓታት ኦንላይን ስብሰባ ያስይዙ'
              : _customerTravels
              ? 'በእነዚህ ሰዓታት ቀጠሮ ያስይዙ'
              : 'ተጨማሪ የስራ ሰዓታት ይጠይቁ',
          ...
          'vacation_confirm': 'ይህን እረፍት መሰረዝ እርግጠኛ ነዎት?',
          'permanent_off': 'ቋሚ የእረፍት ቀን',
          'weekend_msg': 'በባለሙያው ቋሚ የእረፍት ቀን ጥያቄ ማቅረብ አይቻልም።',
          'vacation_conflict': 'በእረፍት ጊዜ የስራ ቀን ማስቀመጥ አይቻልም።',
          'work_conflict': 'በነባር የስራ ቀን ላይ እረፍት ማስቀመጥ አይቻልም።',
          'working_day': 'የስራ ቀን',
          'has_reminders': 'ማስታወሻዎች',
          'notes': 'የቀን ማስታወሻዎች',
          'notes_hint': 'የግል ማስታወሻዎችን እዚህ ይጻፉ...',
          'invalid_hours': 'መጨረሻ ሰዓት ከመጀመሪያ በኋላ መሆን አለበት።',
          'overlap_hours': 'የሰዓት ክልሎች መደራረብ አይችሉም።',
          'add_time_range': 'የሰዓት ክልል ጨምር',
          'remove_time_range': 'ክልል አስወግድ',
          'time_range': 'የሰዓት ክልል',
          'multi_hours_hint': 'ለአንድ ቀን ብዙ የስራ ሰዓት ክልሎችን ማከል ይችላሉ።',
          'selected_hours': 'የተመረጡ ሰዓታት',
          'edit_hours_hint': 'ክልሎቹን ለማስተካከል "ከፊል የስራ ሰዓታት" ይጫኑ።',
          'clock_hint': 'ሰዓቱን ለመክፈት መጀመሪያ/መጨረሻ ሰዓት ይጫኑ።',
          'range_count': 'የሰዓት ክልሎች',
          'hours_preview': 'ቅድመ እይታ',
          'save_hours_failed': 'የስራ ሰዓታትን ማስቀመጥ አልተሳካም።',
        };
      case 'ru':
        return {
          'title': 'Расписание',
          'manage_title': 'Управление расписанием',
          ...
          'partial_title': 'Выберите рабочие часы',
          'from': 'С',
          'to': 'По',
          'save': 'Сохранить',
          'cancel': 'Отмена',
          'ok': 'ОК',
          'confirm_msg':
              'Отмена рабочего дня удалит все напоминания за этот день. Продолжить?',
          'not_working': 'В этот день нет активности',
          'working_hours': 'Рабочие часы',
          'hidden_msg': 'Расписание специалиста скрыто',
          'request_work': _onlineOnly
              ? 'Записаться онлайн в этот день'
              : _customerTravels
              ? 'Записаться на этот день'
              : 'Запросить работу специалиста в этот день',
          'request_hours': _onlineOnly
              ? 'Записаться онлайн в эти часы'
              : _customerTravels
          ...
          'vacation_confirm': 'Вы уверены, что хотите отменить этот отпуск?',
          'permanent_off': 'Постоянный выходной',
          'weekend_msg':
              'Нельзя отправлять запросы в постоянный выходной специалиста.',
          'vacation_conflict':
              'Нельзя назначить рабочий день во время отпуска.',
          'work_conflict':
              'Нельзя назначить отпуск на существующий рабочий день.',
          'working_day': 'Рабочий день',
          'has_reminders': 'Напоминания',
          'notes': 'Заметки на день',
          'notes_hint': 'Введите личные заметки...',
          'invalid_hours': 'Время окончания должно быть позже начала.',
          'overlap_hours': 'Временные диапазоны не должны пересекаться.',
          'add_time_range': 'Добавить диапазон',
          'remove_time_range': 'Удалить диапазон',
          'time_range': 'Диапазон времени',
          'multi_hours_hint':
              'Можно добавить несколько диапазонов рабочего времени на один день.',
          'selected_hours': 'Выбранные часы',
          'edit_hours_hint':
              'Нажмите "Частичные рабочие часы", чтобы изменить диапазоны.',
          'clock_hint':
              'Нажмите на время начала или окончания, чтобы открыть выбор времени.',
          'range_count': 'Диапазоны',
          'hours_preview': 'Предпросмотр',
          'save_hours_failed':
              'Не удалось сохранить рабочие часы. Попробуйте снова.',
        };
      default:
        return {
          'title': 'Schedule',
