    ...
    switch (locale) {
      case 'he':
        return {
          ...
          'secure_review': 'המידע נשמר בצורה מאובטחת והעסק מאומת מיד.',
          'accept_all_legal': 'עליך לאשר את כל ההצהרות החוקיות',
          'business_id_connected': 'מספר העסק הזה כבר מחובר לחשבון אחר',
          'request_submitted': 'העסק אומת בהצלחה',
          'submitted_for_review': 'החשבון שלך מוכן לשימוש.',
          'got_it': 'הבנתי',
      ...
      case 'ar':
        return {
          ...
          'secure_review': 'تُحفظ معلوماتك بأمان ويتم التحقق من النشاط فورًا.',
          ...
          'request_submitted': 'تم التحقق من النشاط بنجاح',
          'submitted_for_review': 'حسابك جاهز للاستخدام.',
          'got_it': 'فهمت',
      ...
      case 'ru':
        return {
          ...
          'secure_review':
              'Данные надежно хранятся, а бизнес подтверждается сразу.',
          ...
          'request_submitted': 'Бизнес успешно подтвержден',
          'submitted_for_review': 'Ваш аккаунт готов к использованию.',
          'got_it': 'Понятно',
          ...
          'submit': 'Сохранить и подтвердить бизнес',
      ...
      default:
        return {
          ...
          'secure_review':
              'Your information is stored securely and your business is verified immediately.',
          'accept_all_legal': 'You must accept all legal declarations',
          'business_id_connected':
              'This business ID is already connected to an account',
          'request_submitted': 'Business Verified Successfully',
          'submitted_for_review': 'Your account is ready to use.',
          'got_it': 'Got it',
      ...
      try {
        ...
        if (doc.exists && mounted) {
          ...
          final hasApprovedVerification =
              savedStatus == 'approved' || savedStatus == 'verified';
          final savedDealerType = (data['dealerType'] ?? userData['dealerType'])
              ?.toString();
          setState(() {
            _currentStatus = hasApprovedVerification
                ? 'approved'
            ...
            _acceptedResponsibility =
                hasApprovedVerification ||
                data['responsibilityAccepted'] == true;
            _businessLogoUrl =
