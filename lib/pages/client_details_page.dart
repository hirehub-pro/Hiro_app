...
class _ClientDetailsStrings {
  ...
  static const _translations = <String, Map<String, String>>{
    'en': {
      ...
      'creditInvoice': 'Tax Invoice Credit',
      'receipt': 'Receipt',
    ...
    'he': {
      ...
      'creditInvoice': 'חשבונית מס זיכוי',
      'receipt': 'קבלה',
    ...
    'ar': {
      ...
      'creditInvoice': 'فاتورة ضريبية دائنة',
      'receipt': 'إيصال',
    ...
    'ru': {
      ...
      'creditInvoice': 'Кредитовый налоговый счёт',
      'receipt': 'Квитанция',
