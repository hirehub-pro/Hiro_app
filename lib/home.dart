...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
        ...
        if (isDesktop)
          Padding(
            ...
            child: GridView.builder(
              ...
              itemCount: _isPopularLoading ? 6 : _popularCategories.length,
              itemBuilder: (context, index) {
                if (_isPopularLoading) {
                  return _buildCategorySkeleton(isDesktop: true);
                }
                ...
                return _buildCategoryTile(
                  ...
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => SearchPage(initialTrade: cat['en']),
                    ),
                  ),
                );
              },
  ...
  Widget _buildCategorySkeleton({bool isDesktop = false}) {
    return Container(
      width: isDesktop ? null : 85,
      margin: EdgeInsets.symmetric(horizontal: isDesktop ? 0 : 8),
      padding: EdgeInsets.all(isDesktop ? 16 : 0),
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Skeleton(height: 12, width: isDesktop ? 88 : 60),
        ],
      ),
    );
  }
