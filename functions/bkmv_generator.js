...
function buildC100(data) {
  ...
  return joinFixed([
    fitAlpha("C100", 4), fitNumeric(data.recordNumber, 9),
    fitNumeric(data.businessNumber, 9), fitNumeric(data.documentType, 3),
    fitAlpha(data.documentNumber, 20), fitNumeric(data.issueDate, 8),
    fitNumeric(data.issueTime, 4), fitAlpha(data.clientName, 50),
    fitAlpha(address.street, 50), fitAlpha(address.houseNumber, 10),
    fitAlpha(address.city, 30), fitAlpha(address.postalCode, 8),
    fitAlpha("", 30), fitAlpha("", 2), fitAlpha(data.clientPhone, 15),
    fitNumeric(data.clientVatNumber, 9), fitNumeric(data.valueDate, 8),
    fitSignedAmount(data.totalAmount, 12, 2), fitAlpha("ILS", 3),
